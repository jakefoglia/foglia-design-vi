...
# Account Information
to = 'jakefoglia@outlook.com' # Email to send to
gmail_user = 'justjakefoglia@gmail.com' # Email to send from (MUST BE GMAIL)
gmail_password = 'tuhxfarllbkyjjqp' # 16-digit Google App Password (without space)
...
msg['Subject'] = 'IP address for jakePI'
msg['From'] = gmail_user
msg['To'] = to
# Sends the message
